            ...
            <Col xs={12} sm={12} md={5} lg={5} xl={5} >
              <div className='quote-box' >
                ...
                <div className='worlds-first' >
                  World's first #Play2Earn PVP Combat game
                </div>
                <div className='Inspired' >
                  Inspired by AI-Powered
                </div>
                <div className='Inspired-with' >
                  with <span className='Inspired-with-MetaDogeUnity'>MetaDogeUnity</span>
                </div>
